    ...
    <footer class="footer-distributed">
      <div class="body">
        <div class="footer-left">
          ...
          <p class="footer-company-name">Shen Levy &copy;</p>
        </div>
        ...
        <div class="footer-right">
          ...
          <span>About the company</span>
                      Lorem ipsum, dolor sit amet consectetur adipisicing elit. Temporibus fugiat deserunt maxime dolorum quibusdam quaerat accusantium. Hic est ipsam cum cumque minima sed rem nisi qui autem? Incidunt, ea reprehenderit.</p>
